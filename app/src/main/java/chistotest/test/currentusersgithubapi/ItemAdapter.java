package chistotest.test.currentusersgithubapi;
...
import chistotest.test.currentusersgithubapi.controller.DetailActivity;
...
public class ItemAdapter extends RecyclerView.Adapter<ItemAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(ViewHolder viewHolder, int i) {
        ...
        Picasso.get()       // Метод with - изменён на: get() - context -> больше не нужен.
    ...
    public class ViewHolder extends RecyclerView.ViewHolder {
        ...
        public ViewHolder(View view) {
            ...
            githublink1 = (TextView) view.findViewById(R.id.guthublink1);
